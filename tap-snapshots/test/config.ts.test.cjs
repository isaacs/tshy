...
exports[`test/config.ts > TAP > {"config":{"tsconfigPath":"thisFileDoesNotExist.json"},"sources":[],"ok":false} > must match snapshot 1`] = `
tshy.tsconfigPath must point to a tsconfig file on disk, got: "thisFileDoesNotExist.json"
`
